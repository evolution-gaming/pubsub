...
class OptimiseSubscribeSpec extends WordSpec with Matchers {

  "OptimiseSubscribe" should {

    "subscribe once and dispatch msgs to all subscribers" in {

      val optimiseSubscribe = OptimiseSubscribe(Sequentially.now, ActorLog.empty)(CurrentThreadExecutionContext)
